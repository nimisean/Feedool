...
<form name ="match_results" action="confirmbot.php" method = "post" id="scores" >

<input  name = 'my_score' type = 'number'  id='score1'  min="0" value='0'/>
<input  name = 'opp_score' type = 'number' id='score2' min="0"  value='0'/>
 <button  id ="exit"  >EXIT</button>
<button  id ='send_result' type = 'button' onclick="showHide();">CLAIMREWARD</button>
...
<p> By Clicking 'yes' , you are claiming the WIN! </p>
